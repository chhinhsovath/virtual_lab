-- TaRL System - Users and Roles for Actual Database Schema
-- This migration creates a proper user management system working with the existing tbl_tarl_* tables
...
CREATE TABLE IF NOT EXISTS users (
  ...
  teacher_id INTEGER REFERENCES tbl_tarl_teacher(teacher_id),
...
CREATE TABLE IF NOT EXISTS tarl_assessments (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  student_id BIGINT NOT NULL REFERENCES tbl_tarl_student(student_id),
  teacher_id INTEGER NOT NULL REFERENCES tbl_tarl_teacher(teacher_id),
  school_id INTEGER NOT NULL REFERENCES tbl_tarl_school(school_id),
